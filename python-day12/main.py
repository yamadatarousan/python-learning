"""
Day12: ミニCLIツール（ディレクトリ走査）— “計算”と“I/O”の分離を強める（FIX版）
...
使い方：
    python main.py [directory] [--mode file|all] [--min-size N] [--top N] [--human] [--json] [--verbose]
"""
...
def build_json_payload(root: Path, mode: str, min_size: int, top_n: int, stats: Stats) -> dict[str, Any]:
    """
